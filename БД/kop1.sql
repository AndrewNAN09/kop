...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 09 2020 г., 14:18
...
INSERT INTO `chat` (`id_chat`, `text`, `id_user`) VALUES
(154, 'dqwad', 1),
(155, 'xaxxaxaxaxaxax', 2),
(156, 'ssssssssssssss', 1),
(157, '33333333', 3);
...
--
ALTER TABLE `chat`
  MODIFY `id_chat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
